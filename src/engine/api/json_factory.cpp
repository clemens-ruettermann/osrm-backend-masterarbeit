...
util::json::Object makeRouteStep(guidance::RouteStep step, util::json::Value geometry)
{
	...
	route_step.values["driving_factor"] = step.driving_factor;
	route_step.values["resistance_factor"] = step.resistance_factor;
                             ...
                             const char *weight_name)
{
	...
	json_route.values["driving_factor"] = route.driving_factor;
	json_route.values["resistance_factor"] = route.resistance_factor;
...
util::json::Object makeRouteLeg(guidance::RouteLeg leg, util::json::Array steps)
{
	...
	route_leg.values["driving_factor"] = leg.driving_factor;
	route_leg.values["resistance_factor"] = leg.resistance_factor;
